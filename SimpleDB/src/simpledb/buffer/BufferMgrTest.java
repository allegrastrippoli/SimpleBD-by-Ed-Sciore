...
public class BufferMgrTest {
	...
	/* 
	 * associa tre blocchi a tre buffer (in realta' blocco 0 pinned twice)
	 * prova ad associare un quarto blocco ma non ci sono buffer disponibili, allora lancia BufferAbortException
	 * 
	 * dopo aver fatto unpin del blocco 2 e' possibile pinnare blocco 3
	 * */
